...
(function () {
  var dict = {
    en: {
      ...
      mat_h2: "Metals and plastics, machined to spec.",
      mat_p: "A selection of what we work with regularly. Need something else? Ask — the list is longer than this.",
    ...
    th: {
      ...
      mat_eyebrow: "วัสดุ",
      mat_h2: "โลหะและพลาสติก กลึงตามสเปก",
      mat_p: "ตัวอย่างวัสดุที่เราใช้งานเป็นประจำ ต้องการวัสดุอื่น? สอบถามได้ — รายการจริงยาวกว่านี้",
